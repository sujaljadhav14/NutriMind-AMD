...
export const suggestionDataByMood: Record<string, SuggestionData> = {
  stressed: {
...
export function getSuggestionData(mood: string | undefined) {
  if (!mood) {
    return suggestionDataByMood.stressed;
  }

  return suggestionDataByMood[mood.toLowerCase()] || suggestionDataByMood.stressed;
}
